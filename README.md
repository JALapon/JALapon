...
- 🎓 MS Software Engineering — **Florida Gulf Coast University** (Jan 2026 – Present)
- - 💼 AI Engineer Intern at **BRDGIT** — building data pipelines and AI-powered automation workflows
  - - 📊 Focused on **Business Intelligence**, **Data Analytics**, and **Automated Reporting**
    - - 🔧 I build end-to-end analytics solutions: from SQL queries to interactive dashboards to n8n pipelines
      - - 🌱 Currently exploring: **dbt**, **Metabase**, and **LLM-powered data workflows**
        ...
        **Tools**
        ...
        - 🐍 **Python & Data** — Global Career Accelerator
        - - 🤖 **AI Professional Skills** — Global Career Accelerator
          - - 🌍 **Intercultural Skills** — Global Career Accelerator
